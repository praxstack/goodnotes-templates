...
**Data classification:** SVGs may contain Prax's therapist names (<REDACTED-PSYCH-FIRST>, Dr <REDACTED-PSYCH-LAST-DR>) and med names. This is already in the repo (see v5-today Rx card). Per design contract, this is personal-use; no PII concern.
