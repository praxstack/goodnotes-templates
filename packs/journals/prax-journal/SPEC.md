...
- Integrates therapist context (Shreya psychology · Dr Pallavi psychiatry)
...
- `tests/visual/v5-snapshots.test.ts` — re-baselined against `packs/journals/prax-journal/versions/v5/*`
