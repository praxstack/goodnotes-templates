...
### v5 — Prax-personal (4-page, Shreya + Dr Joshi integration)
| Type | Filename | Template ID |
|---|---|---|
...
**v4 vs v5:** Both share this design contract 1:1 — same tokens, same fonts, same component library, same voice. v5 adds therapist-specific blocks (2-Sec Pause, Jar+Body, Chest-kg, Dr Joshi's Rx card, Named Patterns, Nutritional meds). v4 stays as the generic/shippable product line.
